...
export class SubCategoryComponent implements OnInit {
  ...
  getSubCategory(): void{
    this.subCategory$ = this.apiSvc.getSubCategory().pipe(
      tap(res => {
  ...
  handleSubmitEdit(): void {
    ...
    if(this.categoryFormEdit.valid){
      this.apiSvc.editSubCategory(this.categoryFormEdit.value.id,this.categoryFormEdit.value.name, this.categoryFormEdit.value.description).subscribe({
        next: () => {
