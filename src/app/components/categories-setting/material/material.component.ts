...
export class MaterialComponent {
  ...
  getMaterial(): void{
    this.material$ = this.apiSvc.getMaterial().pipe(
      tap(res => {
  ...
  handleSubmitEdit(): void {
    ...
    if(this.categoryFormEdit.valid){
      this.apiSvc.editMaterial(this.categoryFormEdit.value.id,this.categoryFormEdit.value.name, this.categoryFormEdit.value.description).subscribe({
        next: () => {
