...
export class ContactTypeComponent implements OnInit {
  ...
  handleSubmitEdit(): void {
    ...
    if(this.categoryFormEdit.valid){
      this.apiSvc.editContactType(this.categoryFormEdit.value.id,this.categoryFormEdit.value.name, this.categoryFormEdit.value.description).subscribe({
        next: () => {
  ...
  handleSubmitAdd(): void{
    ...
    if(this.categoryForm.valid){
      this.apiSvc.createContactType(this.categoryForm.value.name, this.categoryForm.value.description).subscribe({
        next: () => {
