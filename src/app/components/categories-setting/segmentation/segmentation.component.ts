...
export class SegmentationComponent {
  ...
  getMaterial(): void{
    this.segmentation$ = this.apiSvc.getSegmentation().pipe(
      tap(res => {
  ...
  handleSubmitEdit(): void {
    ...
    if(this.categoryFormEdit.valid){
      this.apiSvc.editSegmentation(this.categoryFormEdit.value.id,this.categoryFormEdit.value.name, this.categoryFormEdit.value.description).subscribe({
        next: () => {
